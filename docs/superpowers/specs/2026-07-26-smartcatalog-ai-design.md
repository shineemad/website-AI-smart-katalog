...
| GET | `/api/v1/products` | publik | filter: category, minPrice, maxPrice |
...
- **Home:** grid card produk responsif, filter kategori & harga, Global AI Search bar dengan hasil rekomendasi AI + kartu produk.
